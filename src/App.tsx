...
function obtener_data_form(){
    ...
    post_almacen(nombre.value).then(function (response) {
...
function obtener_data_form_update(){
    ...
    actualizar(parseInt(id.value), nombre.value, bool_var).then(function (response) {
      imprimir_data()
...
function obtener_data_form_delete(){
    ...
    eliminar(parseInt(id.value)).then(function (response) {
      imprimir_data()
...
function obtener_data_form_get_id(){
  ...
  getID(id.value).then(function (response) {
  ...
  return (
      <div>
        ...
        <div className="container_update">
          <input type="text" name="id_marca" id="id_marca" placeholder="Id de la marca"/>
          <input type="text" name="nombre_actualizar" id="nombre_actualizar" placeholder="Nombre"/>
          <input type="checkbox" name="estado" id="estado" />
          <input type="button" value="Enviar" onClick={obtener_data_form_update}/>
        </div>
        <hr />
        <h1>Eliminar por id</h1>
        <input type="text" name="id_eliminar" id="id_eliminar" />
        <input type="button" value="Eliminar" onClick={obtener_data_form_delete}/>
        <hr />
